...
function BookingForm() {
  return (
    <div className={styles.booking_form_style}>
        <h1 className={styles.title_style2}>Datos de tu reserva</h1>
        ...
        <input className={styles.input_style} type="text" placeholder='Ingresa tu nombre'/>
        <h2 className={styles.subtitle_style}>Ciudad Destino</h2>
        <input className={styles.input_style} type="text" placeholder='Selecciona destino'/>
    </div>
  )
}
